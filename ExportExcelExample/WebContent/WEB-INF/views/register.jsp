...
<body>
		...
		<form:form method="GET"  modelAttribute="EmployeeModel">
	   		<table align="center" border="1">
			    ...
			    <tr>
                    ...
                    <td>
                    	...
                    	placeholder="Enter Age" id="empAgeId"  maxlength="3"
	...
	<table align="center" border="1" class="GridOne">
		...
		<c:forEach items="${al}" var="alt"><!-- for each loop -->
			<tr>
				...
				<td align="center"><a href="edit?=${alt.empId}">Edit</a>
				<td><a href="delete?=${alt.empId}">Delete</a>
			</tr>
		</c:forEach>
